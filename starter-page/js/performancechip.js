...
var w = parseInt(d3.select('#genechip').style('width'), 10) - 30,
    h = ((4/3) * w) - 30, // 4 by 3 aspect ratio
...
var colorMapping = ["YlOrRd", "YlOrBr", "Purples","Greens", "Blues", "Oranges", "Reds","Greys"];
...
var svg = d3.select("#genechip").append("div")
    .attr("class", "chart")
    .style("width", w + "px")
    .style("height", h + "px")
    .append("svg:svg")
    ...
    .style("fill", function (d) {
          ...
          if (Number(d.categoryId) > 0) {
            eval("var subColor = d3.scale.ordinal()" +
                  ".domain([0,1,2])" +
                  ".range(colorbrewer." + colorMapping[d.categoryId]+ "[3]);");
            return subColor(d.geneValue);
          }
          
          var color = d3.scale.ordinal()
            .domain([0,1,2])
            .range(colorbrewer.YlOrRd[3]);
          return color(d.geneValue);
});
